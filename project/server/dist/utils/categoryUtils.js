 ...
 */
export function determineCategory(title, content = '', imageUrl = '') {
    if (!title)
        return 'Tin tức';
    ...
    const categoryKeywords = {
        ...
        'Công nghệ': [
            { keywords: ['công nghệ', 'smartphone', 'máy tính', 'laptop', 'điện thoại', 'ai', 'trí tuệ nhân tạo'], weight: 3 },
            { keywords: ['app', 'ứng dụng', 'phần mềm', 'máy tính bảng', 'thông minh', 'kỹ thuật số'], weight: 2 },
            { keywords: ['apple', 'samsung', 'xiaomi', 'google', 'microsoft', 'amazon'], weight: 1 }
        ],
        'Giáo dục': [
    ...
    for (const [category, keywordGroups] of Object.entries(categoryKeywords)) {
        ...
        const imageCategories = {
            ...
            'Xe': ['xehoi', 'xemay', 'xe', 'car', 'bike', 'motor', 'automotive'],
